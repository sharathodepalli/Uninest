...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-teal-50">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Discover verified student housing near your university. Connect with trusted hosts and find your home away from home.
            </p>
          </div>
